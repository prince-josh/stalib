...
if (isset($_GET['q'])) {
    $q = $_GET['q'];
    $sel = "SELECT * from books where title like '%$q%' order by id desc";
...
<head>
    ...
    <title>Search Result - STALib</title>
</head>
<body>
    <header id='page-top'>
    <?php include "header.php";?>
      ...
      <?php 
        if ($count == 0) {
            echo "<center> <h3 class='mt-5'> Your Search Did Not Yeild Any Result, Please Search Using More Specific Keywords </h3></center>";
        }
        ?>
        <?php 
